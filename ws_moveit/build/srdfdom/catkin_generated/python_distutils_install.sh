...
echo_and_run cd "/home/csg/ws_moveit/src/srdfdom"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/csg/ws_moveit/src/srdfdom/setup.py" \
    egg_info --egg-base /home/csg/ws_moveit/build/srdfdom \
    build --build-base "/home/csg/ws_moveit/build/srdfdom" \
    install \
    --root="${DESTDIR-/}" \
